...
func (c *EventingV1alpha1Client) RabbitmqBrokerConfigs(namespace string) RabbitmqBrokerConfigInterface {
	return newRabbitmqBrokerConfigs(c, namespace)
}
