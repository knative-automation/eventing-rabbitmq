...
type BindingInformer interface {
	...
	Lister() rabbitmqcomv1beta1.BindingLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RabbitmqV1beta1().Bindings(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RabbitmqV1beta1().Bindings(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RabbitmqV1beta1().Bindings(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RabbitmqV1beta1().Bindings(namespace).Watch(ctx, options)
			},
		}, client),
		&apisrabbitmqcomv1beta1.Binding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *bindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisrabbitmqcomv1beta1.Binding{}, f.defaultInformer)
}

func (f *bindingInformer) Lister() rabbitmqcomv1beta1.BindingLister {
	return rabbitmqcomv1beta1.NewBindingLister(f.Informer().GetIndexer())
}
