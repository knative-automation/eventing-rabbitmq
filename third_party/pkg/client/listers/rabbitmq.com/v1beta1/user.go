...
type UserLister interface {
	...
	List(selector labels.Selector) (ret []*rabbitmqcomv1beta1.User, err error)
...
type userLister struct {
	listers.ResourceIndexer[*rabbitmqcomv1beta1.User]
}

// NewUserLister returns a new UserLister.
func NewUserLister(indexer cache.Indexer) UserLister {
	return &userLister{listers.New[*rabbitmqcomv1beta1.User](indexer, rabbitmqcomv1beta1.Resource("user"))}
}

// Users returns an object that can list and get Users.
func (s *userLister) Users(namespace string) UserNamespaceLister {
	return userNamespaceLister{listers.NewNamespaced[*rabbitmqcomv1beta1.User](s.ResourceIndexer, namespace)}
}
...
type UserNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*rabbitmqcomv1beta1.User, error)
